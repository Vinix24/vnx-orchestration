...
## Overview
Smart Tap V7 adds JSON dispatch support with automatic Markdown translation. T0 can create dispatches in structured JSON format for machine-readable precision, and the system translates them to Markdown for popups and terminal display.
