...
**Status**: ⚠️ HISTORICAL — `report_watcher.sh` is deprecated; see `RECEIPT_PIPELINE.md` for the active `receipt_processor.sh` flow
...
> `scripts/receipt_processor.sh` — see `RECEIPT_PIPELINE.md` for current documentation.
