...
- Name: agent-stream.spec.ts >> Agent Stream Page >> event content renders correctly
- Location: e2e/agent-stream.spec.ts:85:7
...
Locator: getByText('Session started: sess-abc')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Session started: sess-abc')
