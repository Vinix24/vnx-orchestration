...
- Name: agent-stream.spec.ts >> Agent Stream Page >> terminal selector switches active terminal
- Location: e2e/agent-stream.spec.ts:23:7
...
Locator:  locator('button').filter({ hasText: 'T2' }).first()
Expected: "600"
Received: "400"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('button').filter({ hasText: 'T2' }).first()
    9 × locator resolved to <button title="T2">…</button>
      ...
      - generic [ref=e68]:
        ...
        - generic [ref=e74]:
          - generic [ref=e75]:
            - img [ref=e76]
            - text: Disconnected
          - button "Pause" [ref=e78] [cursor=pointer]:
            - img [ref=e79]
            - text: Pause
          - generic [ref=e82]:
            - button "T1" [ref=e83] [cursor=pointer]:
              - generic [ref=e84]: T1
            - button "T2" [active] [ref=e85] [cursor=pointer]:
              - generic [ref=e86]: T2
