...
def _dispatch_claude(args: argparse.Namespace) -> int:
    ...
    try:
        from subprocess_dispatch_internals.delivery import get_token_usage, clear_token_usage
        _claude_token_usage = get_token_usage(args.dispatch_id)
        clear_token_usage(args.dispatch_id)
