#!/usr/bin/env python3
"""
VNX Doctor Checks — Individual runtime health checks for vnx doctor.

Extracted from vnx_doctor_runtime.py. Provides all check_* functions,
compute_recovery_preflight, and the CheckResult dataclass.
        ...
        with get_connection(state_dir) as conn:
            ...
            if invalid_states:
                return CheckResult(
                    name="lease_health",
                    status=FAIL,
                    message="Invalid lease states detected",
