...
def _deliver(
    ...
    # Mirrors pool_worker_runner.py's and claude_adapter.py's VNX_DISPATCH_MODEL default:
    # build workers default to sonnet (workers-kimi-pinned, vnx_workers.default.yaml).
