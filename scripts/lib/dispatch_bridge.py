...
owns lane selection (claude→headless). No Anthropic SDK import.
"""
...
# The sentinel set itself lives in dispatch_spec.LEGACY_GATE_SENTINELS (next to
...
def deliver_via_door(
    ...
    *,
    ...
    None reproduce byte-identical prior behavior. Headless is the only claude lane
    (the tmux lane was removed 2026-09-18), so these defaults mean "accept the
    default".
